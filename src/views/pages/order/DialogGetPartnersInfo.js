...
import {useGetPartnerInfoByOrderIdQuery} from "../../../redux/apps/orders/ordersApi";
...
const DialogGetPartnerInfo = ({ show, handleDialog, row }) =>{
  const [tabValue, setTabValue] = useState('basic')

  const { isLoading, isError, error, data}= useGetPartnerInfoByOrderIdQuery(row?.id)
    ...
    <Box>
      ...
      >
        ...
        >
          ...
          />
          <Card>
            <CardHeader title={<Typography variant={'h3'}>Delivery Partner's Information</Typography>} />
            <CardContent>
              <Box sx={{mt: 10}}>
...
export default DialogGetPartnerInfo;
