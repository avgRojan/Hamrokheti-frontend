  ...
  return {
    palette: {
      ...
      text: {
        ...
        rustyRed: '#BD3C14',
        redOrange: '#FF2717',
        pinkRaspberry: '#E71F63',
        purpleMountainMajesty: '#8F3E97',
        liberty: '#65499D',
        mediumElectricBlue: '#4554A4',
        mediumPersianBlue: '#1770AB',
        mayaBlue: '#0B9BE3',
        turquoiseBlue: '#06A3B7',
        oceanGreen: '#009688',
        islamicGreen: '#009606',
        oliveGreen: '#8D9900',
        darkTangerine: '#FD5D10',
        pumpkinOrange: '#F06291',
      },
      background: {
        card: '#F5F5F5'
      }
