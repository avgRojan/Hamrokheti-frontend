...
import {useChangeUserStatusMutation, useGetAllUsersQuery} from "../../../../redux/apps/users/userApi";
...
const UsersListPage = () => {
  ...
  const [changeStatus, {isLoading, isSuccess, error, isError, data: statusData}] = useChangeUserStatusMutation()
  ...
  return (
    <>
      <Card>
        <CardHeader title={<Typography variant={'h3'}>User List</Typography>} />
        <DialogConfirmation
