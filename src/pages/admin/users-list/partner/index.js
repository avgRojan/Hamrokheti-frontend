...
import {useChangePartnerStatusMutation, useGetAllPartnersQuery} from "../../../../redux/apps/profile/profileApi";
...
const PartnersListPage = () => {
  ...
  const [changeStatus, {isLoading, isSuccess, error, isError, data: statusData}] = useChangePartnerStatusMutation()
  ...
  return (
    <>
      <Card>
        <CardHeader title={<Typography variant={'h3'}>Partner List</Typography>} />
        <DialogConfirmation
