...
import {useChangeCustomerStatusMutation, useGetAllCustomersQuery} from "../../../../redux/apps/profile/profileApi";
import DialogConfirmation from "../../../../views/component/dialog/DialogConfirmation";
import {useChangeUserStatusMutation} from "../../../../redux/apps/users/userApi";
...
const CustomerListPage = () => {
  ...
  const [changeStatus, {isLoading, isSuccess, error, isError, data: statusData}] = useChangeCustomerStatusMutation()
  ...
  return (
    <>
      <Card>
        <CardHeader title={<Typography variant={'h3'}>Customer List</Typography>} />
        <DialogConfirmation
